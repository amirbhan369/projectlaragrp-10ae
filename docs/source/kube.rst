Scaling [projectlaragrp-10ae] With Kubernetes
===========================
...
Based on your TML solution [projectlaragrp-10ae] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`projectlaragrp-10ae.yml`
...
.. code-block:: YAML
   ...
   kubectl create -f mysql-storage.yml -f mysql-db-deployment.yml -f qdrant.yml -f privategpt.yml -f projectlaragrp-10ae.yml

projectlaragrp-10ae.yml
------------------------

.. important::
   Copy and Paste this YAML file: projectlaragrp-10ae.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# projectlaragrp-10ae.yml
     ...
     kind: Deployment
     metadata:
       name: projectlaragrp-10ae
     spec:
       selector:
         matchLabels:
           app: projectlaragrp-10ae
       ...
       template:
         ...
         spec:
           containers:
           - name: projectlaragrp-10ae
             image: dockeramir33/projectlaragrp-10ae-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: SOLUTIONNAME
               value: 'projectlaragrp-10ae'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae'
             - name: GITUSERNAME
               value: 'amirbhan369'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: projectlaragrp-10ae-service
       labels:
         app: projectlaragrp-10ae-service
     spec:
...
.. code-block::
   ...
   kubectl port-forward deployment/projectlaragrp-10ae 55045:55045

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:55045/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
