[projectlaragrp-10ae] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [projectlaragrp-10ae] container is NOT running**.

.. tip::
   You must have your [projectlaragrp-10ae] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/amirbhan369/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/amirbhan369/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42651  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='amirbhan369'  \-\-env DOCKERUSERNAME='dockeramir33'  \-\-env MQTTUSERNAME='amirhivemq'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   dockeramir33/projectlaragrp-10ae-amd64 (https://hub.docker.com/r/dockeramir33/projectlaragrp-10ae-amd64)
...
.. code-block::
   ...
   docker run -d -p 51887:51887 -p 42977:42977 -p 55045:55045 -p 8883:8883 \
          --env TSS=0 \
          --env SOLUTIONNAME=projectlaragrp-10ae \
          --env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae \
          --env GITUSERNAME=amirbhan369 \
          --env GITREPOURL=https://github.com/amirbhan369/raspberrypi.git \
          --env SOLUTIONEXTERNALPORT=51887 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=42977  \
          --env SOLUTIONVIPERVIZPORT=55045 \
          --env DOCKERUSERNAME='dockeramir33' \
          --env CLIENTPORT=8883  \
          --env EXTERNALPORT=42651 \
          --env KAFKACLOUDUSERNAME='' \
          --env VIPERVIZPORT=9005 \
          --env MQTTUSERNAME='amirhivemq' \
          --env AIRFLOWPORT=9000  \
          --env GITPASSWORD='<Enter Github Password>' \
          --env KAFKACLOUDPASSWORD='<Enter API secret>' \
          --env MQTTPASSWORD='<Enter mqtt password>' \
          --env READTHEDOCS='<Enter Readthedocs token>' \
          dockeramir33/projectlaragrp-10ae-amd64
...
[projectlaragrp-10ae] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/amirbhan369/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/projectlaragrp-10ae
...
.. important::
   https://projectlaragrp-10ae.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae
...
.. important::
   VIPERHOST_PRODUCE=192.168.49.1, VIPERPORT_PRODUCE=51887, VIPERHOST_PREPOCESS=192.168.49.1, VIPERPORT_PREPROCESS=44317, VIPERHOST_PREPOCESS2=192.168.49.1, VIPERPORT_PREPROCESS2=43331, VIPERHOST_PREPOCESS_PGPT=192.168.49.1, VIPERPORT_PREPROCESS_PGPT=37563, VIPERHOST_ML=192.168.49.1, VIPERPORT_ML=46791, VIPERHOST_PREDCT=192.168.49.1, VIPERPORT_PREDICT=39127, HPDEHOST=192.168.49.1, HPDEPORT=38651, HPDEHOST_PREDICT=192.168.49.1, HPDEPORT_PREDICT=44687

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1703-projectlaragrp-10ae,solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae, python-preprocess-2574-projectlaragrp-10ae,solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae, python-ai-143-projectlaragrp-10ae,solution_preprocessing_ai_mqtt_dag-projectlaragrp-10ae, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
